      ...
      >
        <div className="scroll-track">
          {strip.map((p, i) => (
            <div
              key={i}
              onClick={() => setLightbox(i % allPhotos.length)}
            ...
            >
              ...
              >
                <p className="font-display text-sm italic leading-[1.3] text-white">
                  {p.caption}
                </p>
              </motion.div>
            </div>
        ...
        <div className="scroll-track [animation-direction:reverse] [animation-duration:35s]">
          {[...strip].reverse().map((p, i) => (
            <div
              key={i}
              onClick={() =>
                setLightbox((strip.length - 1 - i) % allPhotos.length)
              }
        ...
        {lightbox !== null && (
          ...
          >
            <motion.div
              ...
              className="relative aspect-[3/2] w-full max-w-[900px]"
            ...
            >
              ...
              {lightbox > 0 && (
                <button
                  ...
                  className="absolute -left-12 top-1/2 h-9 w-9 -translate-y-1/2 cursor-pointer border border-white/20 bg-transparent text-lg text-white"
                >
                  ‹
                </button>
              )}
              {lightbox < allPhotos.length - 1 && (
                <button
                  ...
                  className="absolute -right-12 top-1/2 h-9 w-9 -translate-y-1/2 cursor-pointer border border-white/20 bg-transparent text-lg text-white"
                >
                  ›
                </button>
              )}
